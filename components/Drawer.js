...
function Drawer() {
  ...
  return (
    <nav>
      <div id="drawer-navigation" className="fixed z-[45] sm:hidden block h-screen p-4 overflow-y-auto bg-white w-80 dark:bg-dark" tabIndex="-1" aria-labelledby="drawer-navigation-label">
