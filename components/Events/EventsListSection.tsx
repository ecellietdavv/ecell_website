...
function EventsListSection({
    ...
    return (
      <div className="w-full md:w-1/2 lg:w-1/3 px-4">
        <div className="max-w-[370px] mx-auto mb-10">
          ...
          <div>
            <span className=" bg-primary rounded inline-block text-center py-1 text-xs leading-loose font-semibold dark:text-white">
              {date}
            </span>
  ...
  return (
    <section
      ...
      className="pt-10 overflow-hidden px-6 sm:px-0 lg:pt-12 pb-10 lg:pb-20 relative"
    >
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full px-4">
            <div className="text-center mx-auto mb-[60px] lg:mb-20 max-w-[510px]">
              ...
              <p className="text-base text-body-color">{sectionBio}</p>
            </div>
          </div>
        </div>
