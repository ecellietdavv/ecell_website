...
const Mentor = () => {
  ...
  return (
    <>
        {/* <h3 className='text-3xl sm:text-4xl bg-brand-500 w-full text-center font-bold py-3'>Our Mentors</h3>
        ...
        <div className="w-[30vw] h-[40vh] py-4 flex flex-col text-white bg-brand-500 justify-center space-y-5">
				<h3 className="text-3xl sm:text-4xl w-full text-center font-bold">
					Testimonial
				</h3>
			...
			{tutor.map((value,idx) => {
				...
				<div className="bg-[#0099ff] w-full h-[60%]">
					<h3 className="text-center bg-[#0099ff] text-[#fff] font-semibold text-xl">{value.name}</h3>
					<div className="flex space-x-4 bg-[#0099ff] justify-center my-2">
