      ...
      <div className="max-w-7xl flex w-full items-center justify-between mx-auto px-4 sm:px-6">
        ...
        >
          <Link href="/">
            <Image
              ...
              loading="lazy"
              src={
                !dark ? '/assets/logos/logo_b.png' : '/assets/logos/logo_w.png'
              }
              width={70}
              height={70}
        ...
        >
          ...
          <button
            ...
            className="lg:block hidden bg-brand-400 py-2 px-4 rounded-full bg-gradient-to-r from-brand-500 to-brand-600 hover:to-brand-600 text-white"
          >
            Contact Us
          </button>
