...
function BusinessHero({ id, heroHeading, heroDescription, heroImage }) {
            ...
            <div className="container flex flex-col justify-center py-6 px-2 sm:p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                <div className="flex flex-col justify-center py-6 px-2 sm:p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    <motion.h1 animate={{ y: [50, 0], opacity: [0, 1] }} transition={{ duration: 2, bounce: 1 }} className="text-5xl font-bold leading-none xl:text-6xl">{heroHeading}
                        ...
                        <span className="text-brand-400 sm:pl-3">Business Collaborations</span>
                    </motion.h1>
                    ...
                    <div className="flex flex-col space-y-4 sm:items-center sm:justify-center sm:flex-row sm:space-y-0  sm:space-x-4 lg:justify-start">
                        <motion.button animate={{ x: [50, 0], opacity: [0, 1] }} transition={{ delay: 0.8, duration: 2, bounce: 1 }} type='button' className="px-4 xl:px-8 py-3 text-lg font-semibold rounded bg-brand-400 text-dark" onClick={() => handleScroll("sponsors")}>Past Sponsors</motion.button>
                        <motion.button animate={{ x: [-50, 0], opacity: [0, 1] }} transition={{ delay: 0.8, duration: 2, bounce: 1 }} type='button' onClick={() => handleScroll("testimonials")} className="px-4 xl:px-8 py-3 text-lg font-semibold border rounded dark:border-gray-100">Testimonials</motion.button>
                    </div>
                    <div className="mt-4">Or <span className='underline font-semibold cursor-pointer' onClick={() => handleScroll("pocs")}>Contact Us for Collaborations</span></div>
                </div>
