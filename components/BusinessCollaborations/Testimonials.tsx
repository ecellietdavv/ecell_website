...
const Testimonials = ({ id, testimonials }: TestimonialProps) => {
    ...
    return (
      <div className="">
        <div className="rounded-2xl bg-dark/10 dark:bg-mid dark:text-white snap-center mx-auto my-6">
          ...
          <h3 className="w-5/6 font-medium my-2 mx-auto">{desc}</h3>
          ...
          <div className="">
            ...
            <div className="bg-brand-600 w-full pb-4">
              <h3 className="text-center text-[#fff] font-semibold text-xl">
                {name}
              </h3>
        ...
        >
          {testimonials &&
            testimonials?.map((testimonial, idx) => {
              return <TestimonialsCard testimonial={testimonial} key={idx} />;
            })}
        </ItemsCarousel>
      </div>
    </section>
