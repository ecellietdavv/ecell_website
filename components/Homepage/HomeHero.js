    ...
    return (
        <section id={id} className="2xl:bg-[url('/assets/winner.png')] bg-center bg-no-repeat bg-cover bg-fixed w-full">
            ...
            <div className="relative w-full h-full">
                <div className="bg-black flex justify-center items-center absolute z-30 bg-opacity-40 top-0 left-0 h-full w-full">
                    <div className="text-white">Hi this is div</div>
                </div>
