...
function Footer() {
	return (
		<>
					<hr className=" border-gray-300 sm:mx-auto dark:border-light" />
    <div className="bg-light dark:bg-dark py-8">
        ...
        <p className="mt-3">ph :<span className="font-semibold">+91 9617316561</span></p>
            ...
            <button type="submit" className="text-light mt-3 w-full bg-blue-600 hover:bg-blue-800 focus:outline-none focus:ring-1 focus:ring-blue-200 font-medium rounded-full text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:bg-blue-200 dark:hover:bg-brand">
                Submit
            </button>
        </form>
				</div>
			...
			<div className="lg:mx-24 mx-4 lg:my-8 sm:flex sm:justify-between justify-evenly">
				<span className="text-base text-dark sm:text-center dark:bg-slate-600 text-center">
				...
				<div className="flex mt-4 space-x-6 sm:justify-center justify-evenly sm:mt-0">
					<a
						href="#"
						className="text-gray-800 hover:text-black dark:hover:text-white dark:text-light"
					>
						<svg
							className="w-6 h-6"
							fill="currentColor"
