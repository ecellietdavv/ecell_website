export default {
    ...
    fields: [
        ...
        },
        {
            ...
            title: 'Image',
            type: 'image',
            description: "Upload the image of mentor, default value will be a random image.",
            options: {
                hotspot: true,
            },
        ...
        },
        {
            ...
            title: 'Social Links',
            type: 'object',
            description: "Fill the first 3 fields other values are optional, the default value of social links will be https://linktr.ee/ECellIET",
            fields: [
                {
                    name: "email",
                    title: 'Email',
